...
public class AttributeVertexShader {
	...
	private void CreateBuffers() {
		...
		float[] vertices = {
				1.0f * dfactor,  1.0f * dfactor, 0.0f * dfactor, 1.0f, 0.0f, 0.0f,
				1.0f * dfactor, -1.0f * dfactor, 0.0f * dfactor, 1.0f, 1.0f, 0.0f,
				-1.0f * dfactor, -1.0f * dfactor, 0.0f * dfactor, 0.0f, 1.0f, 0.0f,
				-1.0f * dfactor, 1.0f * dfactor, 0.0f * dfactor, 1.0f, 0.0f, 1.0f,
		};
		...
		GL43.glVertexAttribPointer(0, 3,
				GL43.GL_FLOAT, false, 6 * floatSize, 0);
		GL43.glEnableVertexAttribArray(0);
		
		GL43.glVertexAttribPointer(1, 3,
				GL43.GL_FLOAT, false, 6 * floatSize, 3 * floatSize);
